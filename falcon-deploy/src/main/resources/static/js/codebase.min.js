...
! function(e, t) {
    ...
    function v(e, t) {
        for (var n, i, r = [], o = 0, a = e.length; o < a; o++)(i = e[o]).style && (n = i.style.display, t ? ("none" === n && (r[o] = Le.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && Fe(i) && (r[o] = m(i))) : "none" !== n && (r[o] = "none", Le.set(i, "display", n)));
    ...
    function _(e, t, n, i, r) {
        for (var o, a, s, l, c, u, d = t.createDocumentFragment(), f = [], h = 0, p = e.length; h < p; h++)
            ...
            for (a = a || d.appendChild(t.createElement("div")), s = (qe.exec(o) || ["", ""])[1].toLowerCase(), l = $e[s] || $e._default, a.innerHTML = l[1] + pe.htmlPrefilter(o) + l[2], u = l[0]; u--;) a = a.lastChild;
    ...
    function j(e, t, i, r) {
        ...
        if (f && (o = _(t, e[0].ownerDocument, !1, e, r), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || r)) {
            for (l = (s = pe.map(y(o, "script"), k)).length; d < f; d++) c = o, d !== h && (c = pe.clone(c, !0, !0), l && pe.merge(s, y(c, "script"))), i.call(e[d], c, d);
            if (l)
                for (u = s[s.length - 1].ownerDocument, pe.map(s, A), d = 0; d < l; d++) c = s[d], Ge.test(c.type || "") && !Le.access(c, "globalEval") && pe.contains(u, c) && (c.src ? pe._evalUrl && pe._evalUrl(c.src) : n(c.textContent.replace(it, ""), u))
        }
        return e
    }
    ...
    function R(e, t, n, i, r) {
        var o, a = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2) "margin" === n && (a += pe.css(e, n + We[o], !0, r)), i ? ("content" === n && (a -= pe.css(e, "padding" + We[o], !0, r)), "margin" !== n && (a -= pe.css(e, "border" + We[o] + "Width", !0, r))) : (a += pe.css(e, "padding" + We[o], !0, r), "padding" !== n && (a += pe.css(e, "border" + We[o] + "Width", !0, r)));
        return a
    }
    ...
    function M(e, t, n) {
        ...
        return ot.test(o) ? o : (i = a && (fe.boxSizingReliable() || o === e.style[t]), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + R(e, t, n || (a ? "border" : "content"), i, r) + "px")
    }
    ...
    function W() {
        pt && (!1 === te.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(W) : e.setTimeout(W, pe.fx.interval), pe.fx.tick())
    }
    ...
    function q(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = ht || F(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, a = c.tweens.length; o < a; o++) c.tweens[o].run(i);
            ...
            u = c.props;
        for (V(u, c.opts.specialEasing); o < a; o++)
            if (i = q.prefilters[o].call(c, e, u, c.opts)) return pe.isFunction(i.stop) && (pe._queueHooks(c.elem, c.opts.queue).stop = pe.proxy(i.stop, i)), i;
    ...
    function K(e, t, n, i) {
        ...
        if (Array.isArray(t)) pe.each(t, function(t, r) {
            n || kt.test(e) ? i(e, r) : K(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    var be = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : Q) !== O && j(t), t = t || O, N)) {
                if (11 !== p && (l = ge.exec(e)))
                    if (r = l[1]) {
                        if (9 === p) {
                ...
                if (_.qsa && !V[e + " "] && (!L || !L.test(e))) {
                    if (1 !== p) h = t, f = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(be, _e) : t.setAttribute("id", s = M), o = (u = w(e)).length; o--;) u[o] = "#" + s + " " + d(u[o]);
        ...
        function m(e, t, n, r, o, a) {
            return r && !r[M] && (r = m(r)), o && !o[M] && (o = m(o, a)), i(function(i, a, s, l) {
                var c, u, d, f = [],
                    h = [],
                    m = a.length,
                ...
                } else b = g(b === a ? b.splice(m, b.length) : b), o ? o(null, a, b, l) : z.apply(a, b)
            })
        }
            ...
            var r = n.length > 0,
                ...
                a = function(i, a, s, l, c) {
                    var u, d, f, h = 0,
                        ...
                        E = b.length;
                    for (c && (A = a === O || a || c); p !== E && null != (u = b[p]); p++) {
                        if (o && u) {
                            for (d = 0, a || u.ownerDocument === O || (j(u), s = !N); f = e[d++];)
                                if (f(u, a || O, s)) {
                                    l.push(u);
                                    break
                                }
        ...
        var b, _, C, E, T, w, x, k, A, S, D, j, O, I, N, L, H, P, R, M = "sizzle" + 1 * new Date,
            Q = e.document,
            W = 0,
            F = 0,
            U = n(),
        ...
        try {
            z.apply($ = X.call(Q.childNodes), Q.childNodes), $[Q.childNodes.length].nodeType
        } catch (e) {
            z = {
        ...
        _ = t.support = {}, T = t.isXML = function(e) {
            ...
            return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = O.documentElement, N = !T(O), Q !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), _.attributes = r(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), _.getElementsByTagName = r(function(e) {
                return e.appendChild(O.createComment("")), !e.getElementsByTagName("*").length
            }), _.getElementsByClassName = pe.test(O.getElementsByClassName), _.getById = r(function(e) {
                return I.appendChild(e).id = M, !O.getElementsByName || !O.getElementsByName(M).length
            ...
            }, H = [], L = [], (_.qsa = pe.test(O.querySelectorAll)) && (r(function(e) {
            ...
            }), L = L.length && new RegExp(L.join("|")), H = H.length && new RegExp(H.join("|")), t = pe.test(I.compareDocumentPosition), R = t || pe.test(I.contains) ? function(e, t) {
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !_.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === Q && R(Q, e) ? -1 : t === O || t.ownerDocument === Q && R(Q, t) ? 1 : S ? J(S, e) - J(S, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var n, i = 0,
                    r = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== O && j(e), n = n.replace(le, "='$1']"), _.matchesSelector && N && !V[n + " "] && (!H || !H.test(n)) && (!L || !L.test(n))) try {
                var i = P.call(e, n);
            ...
            var t, n = [],
                i = 0,
                r = 0;
            if (D = !_.detectDuplicates, S = !_.sortStable && e.slice(0), e.sort(q), D) {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return de.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && ce.test(n) && (t = w(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (p = [a ? m.firstChild : m.lastChild], a && y) {
                                for (b = (h = (c = (u = (d = (f = m)[M] || (f[M] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === W && c[1]) && c[2], f = h && m.childNodes[h]; f = ++h && f && f[g] || (b = h = 0) || p.pop();)
                                    if (1 === f.nodeType && ++b && f === t) {
                                        u[e] = [W, h, b];
                                        break
                                    }
                            } else if (y && (f = t, d = f[M] || (f[M] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], h = c[0] === W && c[1], b = h), !1 === b)
                                for (;
                                    (f = ++h && f && f[g] || (b = h = 0) || p.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[M] || (f[M] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), u[e] = [W, b]), f !== t)););
        ...
        return u.prototype = C.filters = C.pseudos, C.setFilters = new u, w = t.tokenize = function(e, n) {
            ...
            var n, i = [],
                ...
                o = V[e + " "];
            if (!o) {
                for (t || (t = w(e)), n = t.length; n--;) o = v(t[n]), o[M] ? i.push(o) : r.push(o);
            ...
            if (n = n || [], 1 === f.length) {
                if ((o = f[0] = f[0].slice(0)).length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && N && C.relative[o[1].type]) {
            ...
            return (u || x(e, f))(i, t, !N, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, _.sortStable = M.split("").sort(q).join("") === M, _.detectDuplicates = !!D, j(), _.sortDetached = r(function(e) {
    ...
    (pe.fn.init = function(e, t, n) {
        ...
        if (n = n || xe, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof pe ? t[0] : t, pe.merge(this, pe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : te, !0)), Te.test(i[1]) && pe.isPlainObject(t))
    ...
    pe.fn.extend({
        ...
        pe.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = pe.filter(i, r)), this.length > 1 && (Se[e] || pe.uniqueSort(r), Ae.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var De = /[^\x20\t\r\n\f]+/g;
    ...
    pe.event = {
        ...
        add: function(e, t, n, i, r) {
            ...
            if (m)
                for (n.handler && (o = n, n = o.handler, r = o.selector), r && pe.find.matchesSelector(Ye, r), n.guid || (n.guid = pe.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                    ...
                    }), c = (t = (t || "").match(De) || [""]).length; c--;) s = Je.exec(t[c]) || [], h = g = s[1], p = (s[2] || "").split(".").sort(), h && (d = pe.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) || h, d = pe.event.special[h] || {}, u = pe.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        return this instanceof pe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? C : E, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && pe.extend(this, t), this.timeStamp = e && e.timeStamp || pe.now(), void(this[pe.expando] = !0)) : new pe.Event(e, t)
    }, pe.Event.prototype = {
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(fe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e)))
                for (a = y(s), o = y(e), i = 0, r = o.length; i < r; i++) D(o[i], a[i]);
            if (t)
                if (n)
        ...
        html: function(e) {
            return Ie(this, function(e) {
                ...
                if ("string" == typeof e && !et.test(e) && !$e[(qe.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    pe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = pe.camelCase(t),
                    l = lt.test(t),
                    c = e.style;
                return l || (t = H(s)), a = pe.cssHooks[t] || pe.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : c[t] : ("string" === (o = typeof n) && (r = Qe.exec(n)) && r[1] && (n = g(e, t, r), o = "number"), void(null != n && n === n && ("number" === o && (n += r && r[3] || (pe.cssNumber[s] ? "" : "px")), fe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))))
            }
        },
        ...
        pe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !st.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, i) : Ue(e, ct, function() {
                    return M(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, o = i && at(e),
                    a = i && R(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, o), o);
                return a && (r = Qe.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), P(e, n, a)
            }
        }
    ...
    pe.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function(n) {
                ...
                var t, i, r, o;
                if ("string" === n)
                    for (i = 0, r = pe(this), o = e.match(De) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    pe.extend(pe.event, {
        trigger: function(t, n, i, r) {
            ...
            if (a = s = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !Et.test(h + pe.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), c = h.indexOf(":") < 0 && "on" + h, t = t[pe.expando] ? t : new pe.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : pe.makeArray(n, [t]), d = pe.event.special[h] || {}, r || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                ...
                for (o = 0;
                    (a = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : d.bindType || h, (u = (Le.get(a, "events") || {})[t.type] && Le.get(a, "handle")) && u.apply(a, n), (u = c && a[c]) && u.apply && Ne(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = h, r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !Ne(i) || c && pe.isFunction(i[h]) && !pe.isWindow(i) && ((s = i[c]) && (i[c] = null), pe.event.triggered = h, i[h](), pe.event.triggered = void 0, s && (i[c] = s)), t.result
            }
        },
    ...
    pe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && Dt.test(this.nodeName) && !St.test(e) && (this.checked || !Ve.test(e))
            }).map(function(e, t) {
                var n = pe(this).val();
    ...
    Wt.href = Tt.href, pe.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, s) {
                var c, f, h, _, C, E = n;
                u || (u = !0, l && e.clearTimeout(l), r = void 0, a = s || "", T.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (_ = J(p, T, i)), _ = Z(p, _, T, c), c ? (p.ifModified && ((C = T.getResponseHeader("Last-Modified")) && (pe.lastModified[o] = C), (C = T.getResponseHeader("etag")) && (pe.etag[o] = C)), 204 === t || "HEAD" === p.type ? E = "nocontent" : 304 === t ? E = "notmodified" : (E = _.state, f = _.data, h = _.error, c = !h)) : (h = E, !t && E || (E = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || E) + "", c ? v.resolveWith(g, [f, E, T]) : v.rejectWith(g, [T, E, h]), T.statusCode(b), b = void 0, d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [T, p, c ? f : h]), y.fireWith(g, [T, E]), d && (m.trigger("ajaxComplete", [T, p]), --pe.active || pe.event.trigger("ajaxStop")))
            }
            ...
            if (v.promise(T), p.url = ((t || p.url || Tt.href) + "").replace(Pt, Tt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(De) || [""], null == p.crossDomain) {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = pe.param(p.data, p.traditional)), z(Rt, p, n, T), u) return T;
            (d = pe.event && p.global) && 0 == pe.active++ && pe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Ht.test(p.type), o = p.url.replace(Ot, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(jt, "+")) : (h = p.url.slice(o.length), p.data && (o += (xt.test(o) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (o = o.replace(It, "$1"), h = (xt.test(o) ? "&" : "?") + "_=" + wt++ + h), p.url = o + h), p.ifModified && (pe.lastModified[o] && T.setRequestHeader("If-Modified-Since", pe.lastModified[o]), pe.etag[o] && T.setRequestHeader("If-None-Match", pe.etag[o])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Qt + "; q=0.01" : "") : p.accepts["*"]);
            for (f in p.headers) T.setRequestHeader(f, p.headers[f]);
            if (p.beforeSend && (!1 === p.beforeSend.call(g, T, p) || u)) return T.abort();
            if (E = "abort", y.add(p.complete), T.done(p.success), T.fail(p.error), r = z(Mt, p, n, T)) {
    ...
    fe.cors = !!Ut && "withCredentials" in Ut, fe.ajax = Ut = !!Ut, pe.ajaxTransport(function(t) {
        var n, i;
        if (fe.cors || Ut && !t.crossDomain) return {
            send: function(r, o) {
                var a, s = t.xhr();
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Ft[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                            binary: s.response
                        } : {
                            text: s.responseText
    ...
    pe.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Vt, "$1" + r) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
        ...
        var i, r, o;
        return t || (fe.createHTMLDocument ? (t = te.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = te.location.href, t.head.appendChild(i)) : t = te), r = Te.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = _([e], t, o), o && o.length && pe(o).remove(), pe.merge([], r.childNodes))
    }, pe.fn.load = function(e, t, n) {
        var i, r, o, a = this,
            s = e.indexOf(" ");
        return s > -1 && (i = G(e.slice(s)), e = e.slice(0, s)), pe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), a.length > 0 && pe.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
    ...
    return pe.noConflict = function(t) {
        return e.$ === pe && (e.$ = Gt), t && e.jQuery === pe && (e.jQuery = qt), pe
    }, t || (e.jQuery = e.$ = pe), pe
}),
function(e, t) {
    ...
    function i(e) {
        ...
        var r = t(e),
            ...
            a = r.overflowX,
            s = r.overflowY;
        return /(auto|scroll)/.test(o + s + a) ? e : i(n(e))
    }
    ...
    function s(e, t) {
        ...
        var d = a(e);
        return d.host ? s(d.host, t) : s(e, a(t).host)
    }
    ...
    function p(e) {
        ...
        if (d || p) {
            var g = t(e);
            d -= u(g, "x"), p -= u(g, "y"), o.width -= d, o.height -= p
        }
        return h(o)
    }
    ...
    function g(e, n) {
        ...
        if (g.marginTop = 0, g.marginLeft = 0, !r && o) {
            ...
            g.top -= d - m, g.bottom -= d - m, g.left -= f - v, g.right -= f - v, g.marginTop = m, g.marginLeft = v
        }
        return (r ? n.contains(l) : n === l && "BODY" !== l.nodeName) && (g = c(g, n)), g
    }
    ...
    function y(e, t, r, o) {
        ...
        if ("viewport" === o) a = m(l);
            ...
            var u = g(c, l);
            if ("HTML" !== c.nodeName || v(l)) a = u;
            else {
                var d = f(),
                    h = d.height,
                    p = d.width;
                a.top += u.top - u.marginTop, a.bottom = h + u.top, a.left += u.left - u.marginLeft, a.right = p + u.left
            }
        }
    ...
    function S() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = C(this.state, this.popper, this.reference), e.placement = _(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = w(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = "absolute", e = A(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    function I(e, t, n, r) {
        ...
        a.addEventListener(t, n, {
            passive: !0
        }), o || I(i(a.parentNode), t, n, r), r.push(a)
    }
    ...
    function U(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
            n = se.indexOf(e),
            i = se.slice(n + 1).concat(se.slice(0, n));
    ...
    function B(e, t, n, i) {
        ...
        if ("vh" === a || "vw" === a) {
            return ("vh" === a ? $(document.documentElement.clientHeight, window.innerHeight || 0) : $(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * o
        }
        return o
    }
    ...
    for (var q = Math.min, G = Math.floor, $ = Math.max, K = ["native code", "[object MutationObserverConstructor]"], Y = "undefined" != typeof window, z = ["Edge", "Trident", "Firefox"], X = 0, J = 0; J < z.length; J += 1)
        if (Y && 0 <= navigator.userAgent.indexOf(z[J])) {
            X = 1;
            break
        }
    var Z, ee = Y && function(e) {
    ...
    return ce.Utils = ("undefined" == typeof window ? global : window).PopperUtils, ce.placements = ae, ce.Defaults = {
        placement: "bottom",
        eventsEnabled: !0,
        removeOnDestroy: !1,
        onCreate: function() {},
        ...
        modifiers: {
                ...
                fn: function(e) {
                    ...
                    if (i) {
                        var r = e.offsets,
                            ...
                            u = {
                                start: re({}, l, o[l]),
                                end: re({}, l, o[l] + o[c] - a[c])
                            };
                        e.offsets.popper = oe({}, a, u[i])
                    }
                    return e
                }
            },
            offset: {
                ...
                fn: function(e, t) {
                    var n, i = t.offset,
                        ...
                        s = o.reference,
                        l = r.split("-")[0];
                    return n = R(+i) ? [+i, 0] : V(i, a, s, l), "left" === l ? (a.top += n[0], a.left -= n[1]) : "right" === l ? (a.top += n[0], a.left += n[1]) : "top" === l ? (a.left += n[0], a.top -= n[1]) : "bottom" === l && (a.left += n[0], a.top += n[1]), e.popper = a, e
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function(e, t) {
                    ...
                    var o = t.priority,
                        ...
                        s = {
                            primary: function(e) {
                                var n = a[e];
                                return a[e] < i[e] && !t.escapeWithReference && (n = $(a[e], i[e])), re({}, e, n)
                            },
                            secondary: function(e) {
                                var n = "right" === e ? "left" : "top",
                                    r = a[n];
                                return a[e] > i[e] && !t.escapeWithReference && (r = q(a[n], i[e] - ("right" === e ? a.width : a.height))), re({}, n, r)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(e, n) {
                    ...
                    return y = $(q(a[c] - g, y), 0), e.arrowElement = i, e.offsets.arrow = {}, e.offsets.arrow[d] = Math.round(y), e.offsets.arrow[f] = "", e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(e, t) {
                    ...
                    return a.forEach(function(s, l) {
                        ...
                        (f || v || b) && (e.flipped = !0, (f || v) && (i = a[l + 1]), b && (o = F(o)), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = oe({}, e.offsets.popper, w(e.instance.popper, e.offsets.reference, e.placement)), e = A(e.instance.modifiers, e, "flip"))
                    }), e
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[a ? "left" : "top"] = o[n] - (s ? r[a ? "width" : "height"] : 0), e.placement = T(t), e.offsets.popper = h(r), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, l, c = void 0 === a ? t.gpuAcceleration : a,
                        ...
                        m = j("transform");
                    if (l = "bottom" == h ? -u.height + f.bottom : f.top, s = "right" == g ? -u.width + f.right : f.left, c && m) d[m] = "translate3d(" + s + "px, " + l + "px, 0)", d[h] = 0, d[g] = 0, d.willChange = "transform";
                    else {
                        var v = "bottom" == h ? -1 : 1,
                            y = "right" == g ? -1 : 1;
                        d[h] = l * v, d[g] = s * y, d.willChange = h + ", " + g
                    }
                    var b = {
                        "x-placement": e.placement
                    };
                    return e.attributes = oe({}, b, e.attributes), e.styles = oe({}, d, e.styles), e.arrowStyles = oe({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
            ...
            applyStyle: {
                ...
                enabled: !0,
                fn: function(e) {
                    return M(e.instance.popper, e.styles), Q(e.instance.popper, e.attributes), e.arrowElement && Object.keys(e.arrowStyles).length && M(e.arrowElement, e.arrowStyles), e
                },
                onLoad: function(e, t, n, i, r) {
                    var o = C(r, t, e),
                        a = _(n.placement, o, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
                    return t.setAttribute("x-placement", a), M(t, {
                        position: "absolute"
                    }), n
                },
...
var bootstrap = function(e, t, n) {
    ...
    var r = function() {
        ...
        s = function() {
            var e = "alert",
                ...
                s = function() {
                    ...
                    return n.close = function(e) {
                        ...
                        var n = this;
                        t(e).removeClass(a.SHOW), r.supportsTransitionEnd() && t(e).hasClass(a.FADE) ? t(e).one(r.TRANSITION_END, function(t) {
            ...
            return t(document).on(i.CLICK_DATA_API, {
                DISMISS: '[data-dismiss="alert"]'
            }.DISMISS, s._handleDismiss(new s)), t.fn[e] = s._jQueryInterface, t.fn[e].Constructor = s, t.fn[e].noConflict = function() {
        ...
        l = function() {
            ...
            return t(document).on(a.CLICK_DATA_API, r.DATA_TOGGLE_CARROT, function(e) {
                e.preventDefault();
                var n = e.target;
                t(n).hasClass(i.BUTTON) || (n = t(n).closest(r.BUTTON)), s._jQueryInterface.call(t(n), "toggle")
            ...
            var e = "carousel",
                ...
                h = function() {
                    ...
                    return h.next = function() {
                        ...
                        return n = t.extend({}, s, n), r.typeCheckConfig(e, n, l), n
                        ...
                        var a = (r + (e === c.PREV ? -1 : 1)) % this._items.length;
                        ...
                        if (e === c.NEXT ? (i = d.LEFT, o = d.NEXT, a = c.LEFT) : (i = d.RIGHT, o = d.PREV, a = c.RIGHT), p && t(p).hasClass(d.ACTIVE)) this._isSliding = !1;
                        else if (!this._triggerSlideEvent(p, a).isDefaultPrevented() && l && p) {
                            ...
                            r.supportsTransitionEnd() && t(this._element).hasClass(d.SLIDE) ? (t(p).addClass(o), r.reflow(p), t(l).addClass(i), t(p).addClass(i), t(l).one(r.TRANSITION_END, function() {
                                t(p).removeClass(i + " " + o).addClass(d.ACTIVE), t(l).removeClass(d.ACTIVE + " " + o + " " + i), s._isSliding = !1, setTimeout(function() {
                                    return t(s._element).trigger(v)
                                }, 0)
                            }).emulateTransitionEnd(600)) : (t(l).removeClass(d.ACTIVE), t(p).addClass(d.ACTIVE), this._isSliding = !1, t(this._element).trigger(v)), m && this.cycle()
                        }
                    }, a._jQueryInterface = function(e) {
                        return this.each(function() {
                            var i = t(this).data(n),
                                r = t.extend({}, s, t(this).data());
                            "object" == typeof e && t.extend(r, e);
                            var o = "string" == typeof e ? e : r.slide;
                            if (i || (i = new a(this, r), t(this).data(n, i)), "number" == typeof e) i.to(e);
                        ...
                        if (i) {
                            ...
                            if (o && t(o).hasClass(d.CAROUSEL)) {
                                ...
                                l && (s.interval = !1), a._jQueryInterface.call(t(o), s), l && t(o).data(n).to(l), e.preventDefault()
                            }
                        }
                    }, o(a, null, [{
                        key: "VERSION",
            ...
            var e = "collapse",
                ...
                f = function() {
                    function i(e, n) {
                        ...
                        for (var i = t(d.DATA_TOGGLE), o = 0; o < i.length; o++) {
                            var a = i[o],
                    ...
                    return f.toggle = function() {
                        ...
                        if (!this._isTransitioning && !t(this._element).hasClass(c.SHOW)) {
                            var o, a;
                            if (this._parent && ((o = t.makeArray(t(this._parent).children().children(d.ACTIVES))).length || (o = null)), !(o && (a = t(o).data(n)) && a._isTransitioning)) {
                                var s = t.Event(l.SHOW);
                                if (t(this._element).trigger(s), !s.isDefaultPrevented()) {
                                    o && (i._jQueryInterface.call(t(o), "hide"), a || t(o).data(n, null));
                                    ...
                                    if (r.supportsTransitionEnd()) {
                                        ...
                                        t(this._element).one(r.TRANSITION_END, f).emulateTransitionEnd(600), this._element.style[u] = this._element[h] + "px"
                                    } else f()
                                }
                            }
                        }
                        ...
                        if (!this._isTransitioning && t(this._element).hasClass(c.SHOW)) {
                            ...
                            if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                ...
                                if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", r.reflow(this._element), t(this._element).addClass(c.COLLAPSING).removeClass(c.COLLAPSE).removeClass(c.SHOW), this._triggerArray.length)
                                    for (var o = 0; o < this._triggerArray.length; o++) {
                                        var a = this._triggerArray[o],
                                            s = r.getSelectorFromElement(a);
                                        null !== s && (t(s).hasClass(c.SHOW) || t(a).addClass(c.COLLAPSED).attr("aria-expanded", !1))
                                    }
                                this.setTransitioning(!0);
                                var u = function() {
                                    e.setTransitioning(!1), t(e._element).removeClass(c.COLLAPSING).addClass(c.COLLAPSE).trigger(l.HIDDEN)
                                };
                                this._element.style[i] = "", r.supportsTransitionEnd() ? t(this._element).one(r.TRANSITION_END, u).emulateTransitionEnd(600) : u()
                            }
                        }
                        ...
                        return n = t.extend({}, a, n), n.toggle = Boolean(n.toggle), r.typeCheckConfig(e, n, s), n
                        ...
                        return this.each(function() {
                            var r = t(this),
                                o = r.data(n),
                                s = t.extend({}, a, r.data(), "object" == typeof e && e);
                            if (!o && s.toggle && /show|hide/.test(e) && (s.toggle = !1), o || (o = new i(this, s), r.data(n, o)), "string" == typeof e) {
            ...
            var e = "dropdown",
                ...
                g = function() {
                    ...
                    return g.toggle = function() {
                        ...
                        return n = t.extend({}, this.constructor.Default, t(this._element).data(), n), r.typeCheckConfig(e, n, this.constructor.DefaultType), n
                        ...
                        return this.each(function() {
                            ...
                            if (n || (n = new s(this, r), t(this).data(i, n)), "string" == typeof e) {
                            ...
                            for (var n = t.makeArray(t(d.DATA_TOGGLE)), r = 0; r < n.length; r++) {
                                ...
                                if (a) {
                                    ...
                                    if (t(o).hasClass(u.SHOW) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && t.contains(o, e.target))) {
                                        ...
                                        t(o).trigger(h), h.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), n[r].setAttribute("aria-expanded", "false"), t(f).removeClass(u.SHOW), t(o).removeClass(u.SHOW).trigger(t.Event(c.HIDDEN, l)))
                                    }
                                }
                            }
                    }, s._getParentFromElement = function(e) {
                        var n, i = r.getSelectorFromElement(e);
                        ...
                        if (!(!l.test(e.which) || /button/i.test(e.target.tagName) && 32 === e.which || /input|textarea/i.test(e.target.tagName) || (e.preventDefault(), e.stopPropagation(), this.disabled || t(this).hasClass(u.DISABLED)))) {
                            ...
                            if ((i || 27 === e.which && 32 === e.which) && (!i || 27 !== e.which && 32 !== e.which)) {
                                ...
                                if (27 === e.which) {
                                    var a = t(n).find(d.DATA_TOGGLE)[0];
                                    t(a).trigger("focus")
                                }
        ...
        f = function() {
                ...
                u = function() {
                    ...
                    return u.toggle = function(e) {
                        ...
                        if (!this._isTransitioning && !this._isShown) {
                            r.supportsTransitionEnd() && t(this._element).hasClass(l.FADE) && (this._isTransitioning = !0);
                            var i = t.Event(s.SHOW, {
                                relatedTarget: e
                            });
                            t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(l.OPEN), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(s.CLICK_DISMISS, c.DATA_DISMISS, function(e) {
                                return n.hide(e)
                            }), t(this._dialog).on(s.MOUSEDOWN_DISMISS, function() {
                                t(n._element).one(s.MOUSEUP_DISMISS, function(e) {
                        ...
                        if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                            var i = t.Event(s.HIDE);
                            if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                                this._isShown = !1;
                                var o = r.supportsTransitionEnd() && t(this._element).hasClass(l.FADE);
                                o && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(s.FOCUSIN), t(this._element).removeClass(l.SHOW), t(this._element).off(s.CLICK_DISMISS), t(this._dialog).off(s.MOUSEDOWN_DISMISS), o ? t(this._element).one(r.TRANSITION_END, function(e) {
                        ...
                        return n = t.extend({}, i, n), r.typeCheckConfig(e, n, a), n
                    }, u._showElement = function(e) {
                        var n = this,
                            i = r.supportsTransitionEnd() && t(this._element).hasClass(l.FADE);
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, i && r.reflow(this._element), t(this._element).addClass(l.SHOW), this._config.focus && this._enforceFocus();
                        var o = t.Event(s.SHOWN, {
                                relatedTarget: e
                            }),
                            a = function() {
                        ...
                        var e = this;
                        t(document).off(s.FOCUSIN).on(s.FOCUSIN, function(n) {
                            document === n.target || e._element === n.target || t(e._element).has(n.target).length || e._element.focus()
                        })
                    }, u._setEscapeEvent = function() {
                        var e = this;
                        this._isShown && this._config.keyboard ? t(this._element).on(s.KEYDOWN_DISMISS, function(t) {
                            27 === t.which && (t.preventDefault(), e.hide())
                        }) : this._isShown || t(this._element).off(s.KEYDOWN_DISMISS)
                    }, u._setResizeEvent = function() {
                        var e = this;
                        this._isShown ? t(window).on(s.RESIZE, function(t) {
                            return e.handleUpdate(t)
                        }) : t(window).off(s.RESIZE)
                    }, u._hideModal = function() {
                        var e = this;
                        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._isTransitioning = !1, this._showBackdrop(function() {
                            t(document.body).removeClass(l.OPEN), e._resetAdjustments(), e._resetScrollbar(), t(e._element).trigger(s.HIDDEN)
                        })
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = l.BACKDROP, i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(s.CLICK_DISMISS, function(e) {
                                    n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === n._config.backdrop ? n._element.focus() : n.hide())
                                }), o && r.reflow(this._backdrop), t(this._backdrop).addClass(l.SHOW), !e) return;
                            if (!o) return void e();
                            ...
                            r.supportsTransitionEnd() && t(this._element).hasClass(l.FADE) ? t(this._backdrop).one(r.TRANSITION_END, a).emulateTransitionEnd(150) : a()
                        } else e && e()
                        ...
                        return this.each(function() {
                            var r = t(this).data("bs.modal"),
                                o = t.extend({}, n.Default, t(this).data(), "object" == typeof e && e);
                            if (r || (r = new n(this, o), t(this).data("bs.modal", r)), "string" == typeof e) {
            ...
            return t(document).on(s.CLICK_DATA_API, c.DATA_TOGGLE, function(e) {
                var n, i = this,
                    o = r.getSelectorFromElement(this);
                o && (n = t(o)[0]);
                var a = t(n).data("bs.modal") ? "toggle" : t.extend({}, t(n).data(), t(this).data());
                "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
                var l = t(n).one(s.SHOW, function(e) {
                    e.isDefaultPrevented() || l.one(s.HIDDEN, function() {
                        t(i).is(":visible") && i.focus()
                    })
                });
                u._jQueryInterface.call(t(n), a, this)
                ...
                m = function() {
                    ...
                    return m.enable = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            r.supportsTransitionEnd() && t(this.tip).hasClass(h.FADE) ? t(this.tip).one(r.TRANSITION_END, g).emulateTransitionEnd(a._TRANSITION_DURATION) : g()
                        }
                    }, m.hide = function(e) {
                        var n = this,
                        ...
                        t(this.element).trigger(o), o.isDefaultPrevented() || (t(i).removeClass(h.SHOW), "ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), this._activeTrigger[g.CLICK] = !1, this._activeTrigger[g.FOCUS] = !1, this._activeTrigger[g.HOVER] = !1, r.supportsTransitionEnd() && t(this.tip).hasClass(h.FADE) ? t(i).one(r.TRANSITION_END, a).emulateTransitionEnd(150) : a(), this._hoverState = "")
                    }, m.update = function() {
                        ...
                        return "number" == typeof(n = t.extend({}, this.constructor.Default, t(this.element).data(), n)).delay && (n.delay = {
                            show: n.delay,
                            hide: n.delay
                        }), "number" == typeof n.title && (n.title = n.title.toString()), "number" == typeof n.content && (n.content = n.content.toString()), r.typeCheckConfig(e, n, this.constructor.DefaultType), n
                        ...
                        return this.each(function() {
                            var n = t(this).data("bs.tooltip"),
                                i = "object" == typeof e && e;
                            if ((n || !/dispose|hide/.test(e)) && (n || (n = new a(this, i), t(this).data("bs.tooltip", n)), "string" == typeof e)) {
                                if (void 0 === n[e]) throw new Error('No method named "' + e + '"');
                                n[e]()
                            }
                        })
        ...
        p = function() {
            var e = "popover",
                ...
                s = t.extend({}, h.Default, {
                    placement: "right",
                    trigger: "click",
                    content: "",
                    template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
                }),
                l = t.extend({}, h.DefaultType, {
                ...
                d = function() {
                    ...
                    return d.refresh = function() {
                        ...
                        this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), t.makeArray(t(this._selector)).map(function(e) {
                            var n, a = r.getSelectorFromElement(e);
                            if (a && (n = t(a)[0]), n) {
                                var s = n.getBoundingClientRect();
                                if (s.width || s.height) return [t(n)[i]().top + o, a]
                            }
                            return null
                        }).filter(function(e) {
                            return e
                        ...
                        if ("string" != typeof(n = t.extend({}, i, n)).target) {
                            var o = t(n.target).attr("id");
                            o || (o = r.getUID(e), t(n.target).attr("id", o)), n.target = "#" + o
                        }
                        return r.typeCheckConfig(e, n, a), n
                ...
                s = function() {
                    ...
                    return s.show = function() {
                        ...
                        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(i.ACTIVE) || t(this._element).hasClass(i.DISABLED))) {
                            var o, s, l = t(this._element).closest(a.NAV_LIST_GROUP)[0],
                                c = r.getSelectorFromElement(this._element);
                            if (l) {
                                var u = "UL" === l.nodeName ? a.ACTIVE_UL : a.ACTIVE;
                        ...
                        var s, l = this,
                            c = (s = "UL" === n.nodeName ? t(n).find(a.ACTIVE_UL) : t(n).children(a.ACTIVE))[0],
                            u = o && r.supportsTransitionEnd() && c && t(c).hasClass(i.FADE),
                            d = function() {
                                return l._transitionComplete(e, c, u, o)
                            };
                        c && u ? t(c).one(r.TRANSITION_END, d).emulateTransitionEnd(150) : d(), c && t(c).removeClass(i.SHOW)
                    }, s._transitionComplete = function(e, n, o, s) {
                        if (n) {
                            t(n).removeClass(i.ACTIVE);
                            var l = t(n.parentNode).find(a.DROPDOWN_ACTIVE_CHILD)[0];
                            l && t(l).removeClass(i.ACTIVE), "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !1)
                        }
                        if (t(e).addClass(i.ACTIVE), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), o ? (r.reflow(e), t(e).addClass(i.SHOW)) : t(e).removeClass(i.FADE), e.parentNode && t(e.parentNode).hasClass(i.DROPDOWN_MENU)) {
                            var c = t(e).closest(a.DROPDOWN)[0];
                            c && t(c).find(a.DROPDOWN_TOGGLE).addClass(i.ACTIVE), e.setAttribute("aria-expanded", !0)
                        }
                        s && s()
                    }, e._jQueryInterface = function(n) {
                        return this.each(function() {
    ...
    }(), e.Util = r, e.Alert = s, e.Button = l, e.Carousel = c, e.Collapse = u, e.Dropdown = d, e.Modal = f, e.Popover = p, e.Scrollspy = g, e.Tab = m, e.Tooltip = h, e
}({}, $, Popper);
! function(e) {
    e.fn.extend({
                ...
                if (y.parent().hasClass(i.wrapperClass)) {
                    ...
                    if (a(), e.isPlainObject(n)) {
                        if ("height" in n && "auto" == n.height) {
                            ...
                            E = y.parent().parent().height();
                            y.parent().css("height", E), y.css("height", E)
                        } else "height" in n && (E = n.height, y.parent().css("height", E), y.css("height", E));
                    ...
                    C.css(E), _.css(E), y.wrap(b), y.parent().append(_), y.parent().append(C), i.railDraggable && _.bind("mousedown", function(n) {
                        var i = e(document);
...
var Codebase = function() {
    var e, t, n, i, r, o, a, s, l, c, u, d, f, h, p = function() {
            ...
            switch (h = w(), t) {
                case "init":
                    n.off("click.cb.layout"), n.on("click.cb.layout", '[data-toggle="layout"]', function() {
                        var t = jQuery(this);
                        E(t.data("action")), e.hasClass("no-focus") && t.blur()
                    });
                    break;
                ...
                case "side_overlay_toggle":
                    E(n.hasClass("side-overlay-o") ? "side_overlay_close" : "side_overlay_open");
                    break;
                ...
                case "content_layout_toggle":
                    E(n.hasClass("main-content-boxed") ? "content_layout_narrow" : n.hasClass("main-content-narrow") ? "content_layout_full_width" : "content_layout_boxed");
                    break;
        ...
        T = function(e, t) {
            ...
            if ("init" === t) jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]').each(function() {
                ...
                T(jQuery(this).closest(".block"), jQuery(this).data("action"))
            });
            else {
                ...
                if (e.addClass("js-filter-enabled"), t.length) {
                    ...
                    jQuery(window).on("resize.cb.helpers", function() {
                        clearTimeout(o), o = setTimeout(function() {
                            (a = w()) < 768 ? t.addClass("flex-column") : t.removeClass("flex-column")
                        }, 150)
    ...
    return {
        init: function() {
            p(), g("init"), m(), v(), y(), b(), _(), E("init"), T(!1, "init"), x(), k(), A(), S(), D(), j(), O(), I(), N(), L("hide"), H()
        },
        layout: function(e) {
            E(e)
        },
